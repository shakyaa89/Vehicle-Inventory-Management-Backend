    ...
    public partial class AddedModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerStats_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoyaltyApplied = table.Column<bool>(type: "boolean", nullable: false),
                    IsCredit = table.Column<bool>(type: "boolean", nullable: false),
                    DueAmount = table.Column<int>(type: "integer", nullable: false),
